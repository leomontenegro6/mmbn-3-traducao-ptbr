...
.align 4
NCPETTiles:
    .import navicust\petset.bin
    .align 4
NCBGTiles:
    .import navicust\bgset.bin
    .align 4
NCLetterTiles:
    .import navicust\letterset.bin
    .align 4
NCPalettes:
    .import navicust\palettes.bin
    .align 4
NCAnimData:
    .import navicust\animdata.bin
    .align 4
NCBGTilemap:
    .import navicust\bgmap.bin
    .align 4
