...
script 10 mmbn3 {
	...
	msgOpen
	"""
	A gente também precisa
	ir pro ACDC Plaza, pras
	preliminares!
	"""
	keyWait
	end
...
script 23 mmbn3 {
	...
	msgOpen
	"""
	Vamos lá pegar o dever
	de casa do Dex com ele!
	"""
	keyWait
	end
}
...
script 42 mmbn3 {
	...
	que tá dizendo ser o
	melhor NetLutador daqui!
	"""
	keyWait
	end
}
...
script 44 mmbn3 {
	...
	msgOpen
	"""
	Agora que podemos usar
	a Metrolinha, vamos ir
	ver o papai!
	"""
	keyWait
	end
...
script 48 mmbn3 {
	...
	"""
	As preliminares do
	Grande Prêmio N1 estão
	rolando no SciLab Plaza!
	"""
	keyWait
	end
}
script 49 mmbn3 {
	...
	a batalha de sobrevivên-
	cia! Pro SciLab Plaza!
	"""
	keyWait
	end
}
...
script 241 mmbn3 {
	...
	msgOpen
	"""
	Vamos ler os Fóruns! Se
	o Chaud estiver certo,
