...
script 48 mmbn3 {
	...
	msgOpen
	"""
	Bom, chegamos na área
	SciLab. Agora, achar o
	Plaza!
	"""
	keyWait
	end
...
script 50 mmbn3 {
	...
	o Navi que tá fazendo
	o papel de bandido, né?
	"""
	keyWait
	end
}
script 51 mmbn3 {
	...
	msgOpen
	"""
	Conseguimos! OK, vamos
	voltar pro cara que deu
	a missão!
	"""
	keyWait
	end
